...
type PostOKBody struct {
	...
	// karate
	Karate []*PostOKBodyKarateItems0 `json:"karate"`
}
...
func (o *PostOKBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateKarate(formats); err != nil {
		res = append(res, err)
	}
...
func (o *PostOKBody) validateKarate(formats strfmt.Registry) error {
	if swag.IsZero(o.Karate) { // not required
		return nil
	}

	for i := 0; i < len(o.Karate); i++ {
		if swag.IsZero(o.Karate[i]) { // not required
			continue
		}

		if o.Karate[i] != nil {
			if err := o.Karate[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("postOK" + "." + "karate" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("postOK" + "." + "karate" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *PostOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateKarate(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *PostOKBody) contextValidateKarate(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(o.Karate); i++ {

		if o.Karate[i] != nil {
			if err := o.Karate[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("postOK" + "." + "karate" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("postOK" + "." + "karate" + "." + strconv.Itoa(i))
...
// PostOKBodyKarateItems0 post o k body karate items0
//
// swagger:model PostOKBodyKarateItems0
type PostOKBodyKarateItems0 struct {
...
// Validate validates this post o k body karate items0
func (o *PostOKBodyKarateItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PostOKBodyKarateItems0) validateResult(formats strfmt.Registry) error {
...
func (o *PostOKBodyKarateItems0) validateSuccess(formats strfmt.Registry) error {
...
// ContextValidate validates this post o k body karate items0 based on context it is used
func (o *PostOKBodyKarateItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *PostOKBodyKarateItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *PostOKBodyKarateItems0) UnmarshalBinary(b []byte) error {
	var res PostOKBodyKarateItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
